...
template <class Duration> using timestamp = time_point<Duration>;
} // namespace detail
 ...
 */
using duration_s =
    cuda::std::chrono::duration<int64_t, cuda::std::chrono::seconds::period>;
/**
 * @brief Type alias representing an int64_t duration of milliseconds.
 */
using duration_ms =
    cuda::std::chrono::duration<int64_t,
                                cuda::std::chrono::milliseconds::period>;
/**
 * @brief Type alias representing an int64_t duration of microseconds.
 */
using duration_us =
    cuda::std::chrono::duration<int64_t,
                                cuda::std::chrono::microseconds::period>;
...
using timestamp_s = detail::timestamp<
    cuda::std::chrono::duration<int64_t, cuda::std::ratio<1>>>;
/**
 * @brief Type alias representing an int64_t duration of milliseconds since
 * the unix epoch.
 */
using timestamp_ms =
    detail::timestamp<cuda::std::chrono::duration<int64_t, cuda::std::milli>>;
/**
 * @brief Type alias representing an int64_t duration of microseconds since
 * the unix epoch.
 */
using timestamp_us =
    detail::timestamp<cuda::std::chrono::duration<int64_t, cuda::std::micro>>;
...
int main() {
  ...
  std::cout << std::chrono::time_point<std::chrono::system_clock,
